error id: file://<WORKSPACE>/src/main/scala/miniEtl/DataLoader.scala:[24..29) in Input.VirtualFile("file://<WORKSPACE>/src/main/scala/miniEtl/DataLoader.scala", "package miniEtl

object class DataLoader{
    
}")
file://<WORKSPACE>/file:<WORKSPACE>/src/main/scala/miniEtl/DataLoader.scala
file://<WORKSPACE>/src/main/scala/miniEtl/DataLoader.scala:3: error: expected identifier; obtained class
