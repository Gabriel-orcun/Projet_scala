error id: file://<WORKSPACE>/src/main/scala/miniEtl/DataLoader.scala:[164..169) in Input.VirtualFile("file://<WORKSPACE>/src/main/scala/miniEtl/DataLoader.scala", "package miniEtl
        ...
        Try {
            ...
            case Success(content) => 
                decode[List[Restaurant]](content) match {
                    case Right(footabll) => Right(restaurants)
...
")
file://<WORKSPACE>/file:<WORKSPACE>/src/main/scala/miniEtl/DataLoader.scala
file://<WORKSPACE>/src/main/scala/miniEtl/DataLoader.scala:9: error: expected identifier; obtained class
